...
@section('script')
    <script type="text/javascript">
        ...
        $(document).on('click', '.payer-button', function() {
            ...
            loadPatientInsurances(invoice.transaction_id, currentPatient.id);
        ...
        // Charger les assurances du patient
        function loadPatientInsurances(transactionId,patientId) {
            // Charger les actes des patients
            loadPatientActes(transactionId);
            ...
            actes.forEach(function(acte) {
                ...
                html += `
                    <tr class="fade-in-up">
                        ...
                        <td>
                            <input type="number" name='remise' class="form-control form-control-sm" min="0" max="${sousTotal}">
                        </td>
                    </tr>
                    <hr>
                `;
                    ...
                    <div class="col-md-6 mb-2">
                        <div class="d-flex align-items-center">
                            ...
                            <small class="text-muted">
                                Police: ${insurance.insurance_company.code} | ${remainingLimit}
                            </small>
                        </div>
                    </div>
                `;
                    ...
                    html += `
                        <div class="col-md-6 mb-3">
                            <div class="card border-info">
                                <div class="card-header bg-light d-flex justify-content-between align-items-center">
                                    ...
                                    <div class="form-check">
                                        <input class="form-check-input insurance-checkbox" type="checkbox" 
                                               value="${insurance.insurance_company.id}" id="insurance_${insurance.insurance_company.id}"
                                               data-patient-insurance="${insurance.id}"
                                               data-company-name="${insurance.insurance_company.name}"
                                               data-policy="${insurance.insurance_company.code}"
                                ...
                                <div class="card-body">
                                    <p class="mb-1"><strong>Police:</strong> ${insurance.insurance_company.code}</p>
        ...
        function resetPaymentForm() {
            ...
            $('#montantAPayer').val(invoice ? invoice.patient_amount - transaction.montant_payer : '');
