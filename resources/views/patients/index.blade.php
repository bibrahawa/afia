                                ...
                                <form id="addDepartmentForm" action="{{ route('patient.store') }}" method="POST">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 form-group">
                                            ...
                                            <input type="tel" name="phone" class="form-control" placeholder="Entrez votre numéro de téléphone" value="{{ old('phone') }}" required>
                                            @error('phone')
                                                <small class="text-danger">{{ $message }}</small>
                                            @enderror
                                        </div>
                                        ...
                                        <div class="col-md-6 form-group">
                                            ...
                                            <input type="tel" name="relative_phone" class="form-control" placeholder="Numéro de téléphone du proche" value="{{ old('relative_phone') }}">
                            ...
                            <div class="modal-body">
                                <form id="editDepartmentForm" action="" method="POST">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 form-group">
                                            <label>Telephone :</label>
                                            <input type="tel" name="phone" id="edit_phone" class="form-control" placeholder="Entrez votre numéro de téléphone" value="{{ $patient->user->phone ?? old('phone') }}" required>
                                            @error('phone')
                                                <small class="text-danger">{{ $message }}</small>
                                            @enderror
                                        </div>
