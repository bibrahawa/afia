          ...
          <div class="card">
            <div class="card-header">
              <div class="d-flex align-items-center">
                <h4 class="card-title">Modifier votre consultation en remplissant le formulaire ci-dessous</h4>
              </div>
            </div>

            <div class="card-body">
                <form id="editConsultationForm" action="{{ route('consultation.store', $consultation->id) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="row">
                            ...
                            <div class="form-group form-group-default">
                                ...
                                <select name="department_id" class="form-control" required>
                                    @foreach($departements as $departement)
                                        <option value="{{ $departement->id }}" {{ $departement->id == $consultation->department_id }} ?: selected>{{ $departement->name }}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="col-sm-6">
                            <div class="form-group form-group-default">
                                ...
                                <input type="file" name="fichiers[]" value="" multiple class="form-control">
                            </div>
                        </div>
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <select class="selectpicker" name="tests[]" data-live-search="true" multiple>
                        ...
                        <div class="col-sm-6">
                            <div class="form-group form-group-default">
                                ...
                                <textarea name="motif" class="form-control" rows="3" required>{{ $consultation->motif }}</textarea>
                            </div>
                        </div>
                        ...
                        <div class="col-sm-6">
                            <div class="form-group form-group-default">
                                ...
                                <textarea name="signes_cliniques" class="form-control" rows="3" required>{{ implode(',', $consultation->signes_cliniques ?? []) }}</textarea>
                            </div>
                        </div>
                        ...
                        <div class="col-sm-6">
                            ...
                            <div class="form-group form-group-default">
                                ...
                                <textarea name="observation" class="form-control" rows="3">{{ $consultation->observation }}</textarea>
                            </div>
                        </div>
                    ...
                    <div class="modal-footer border-0">
                        ...
                        <button type="submit" class="btn btn-success" id="saveRowButton" form="editConsultationForm">
                            Modifier
...
@section('script')
    <script type="text/javascript">
        ...
        $('#editConsultationForm').on('submit', function() {
