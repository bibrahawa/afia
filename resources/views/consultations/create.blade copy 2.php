          ...
          <div class="card">
            <div class="card-header">
              <div class="d-flex align-items-center">
                <h4 class="card-title">Créez un nouveau consultation en remplissant le formulaire ci-dessous</h4>
              </div>
            </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6">
                            <div class="form-group row align-items-center">
                                <label for="tests" class="col-auto col-form-label">Examens (facultatif)</label>
                                <div class="col">
                                    <div class="input-group">
                                        <div class="input-group-prepend">
                                            <div class="input-group-text">
                                                <input type="checkbox" id="gridCheck1" aria-label="Checkbox for tests">
                                            </div>
                                        </div>
                                        <select class="selectpicker form-control" id="tests" name="tests[]" data-live-search="true" multiple>
