                    ...
                    <div class="modal-body">
                        ...
                        <div class="prescription" id="prescriptionContent">
                            ...
                            <div class="date-location">
                                {{ $consultation->patient->district }}, le <span class="editable">{{ $consultation->created_at->format('d/m/Y') }}</span>
                            </div>
                            ...
                            <div class="doctor-signature">
                                <div style="margin-bottom: 60px;">Le Service Pharmacie Hôpital</div>
                                <div class="signature-line">
                                    Dr <span class="editable">{{ $consultation->medecin->first_name." ".$consultation->medecin->last_name }}</span>
                                </div>
                            </div>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="examens-document" id="examensContent">
                            <div class="examens-header">
                                ...
                                <div class="examens-subtitle">Centre Hospitalier National Dalal Jamm</div>
                        ...
                        <div class="facture-document" id="factureContent">
                            <div class="facture-header">
                                ...
                                <div class="facture-info">
                                    <div style="font-weight: bold; font-size: 16px;">Centre Hospitalier National Dalal Jamm</div>
                                    <div>Service: {{ $consultation->department->name }}</div>
                                    <div>Ministère de la Santé et de l'Action Sociale</div>
                                    <div>République du Sénégal</div>
                                </div>
                            ...
                            <div style="clear: both; margin-top: 40px;">
                                <div style="margin-bottom: 20px;"><strong>Informations de Paiement:</strong></div>
                                @if($consultation->transaction)
                                    <div style="background: #f8f9fa; padding: 15px; border: 1px solid #ddd;">
                                        <div class="row">
                                            <div class="col-6">
                                                <strong>Montant Total:</strong> {{ number_format($consultation->transaction->total) }} GNF<br>
                                                <strong>Montant Payé:</strong> {{ number_format($consultation->transaction->montant_payer) }} GNF<br>
                                                @php
                                            ...
                                            <div class="col-6">
                                                ...
                                                @else
                                                    <span style="color: orange; font-weight: bold;">PARTIELLEMENT PAYÉ</span>
                                                @endif
                                                <br>
                                                <strong>Date Paiement:</strong> {{ $consultation->transaction->created_at->format('d/m/Y H:i') }}
                                            </div>
                                        </div>
                                    </div>
                                @else
                                    <div style="background: #fff3cd; padding: 15px; border: 1px solid #ffeaa7; color: #856404;">
                                        <i class="fas fa-exclamation-triangle"></i> Aucune transaction enregistrée
                                    </div>
                                @endif
                            </div>
        ...
        <div class="row no-print mb-3">
            <div class="col-md-12 text-right">
                ...
                <a 
                    ...
                    data-info="{{$consultation->medicaments}}"> 
