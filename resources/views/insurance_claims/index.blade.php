...
<body class="bg-gray-100 p-8">
    <div class="max-w-7xl mx-auto bg-white p-6 rounded-lg shadow-md">
        ...
        <div class="mb-4">
            <a href="{{ route('insurance_claims.create') }}" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">Créer une nouvelle réclamation</a>
        </div>
                        ...
                        @foreach ($claims as $claim)
                            <tr>
                                ...
                                <td class="py-2 px-4 border-b text-center">
                                    <a href="{{ route('insurance_claims.show', $claim) }}" class="text-blue-600 hover:text-blue-900 mr-2">Voir</a>
                                    <a href="{{ route('insurance_claims.edit', $claim) }}" class="text-yellow-600 hover:text-yellow-900 mr-2">Modifier</a>
                                    <form action="{{ route('insurance_claims.destroy', $claim) }}" method="POST" class="inline-block" onsubmit="return confirm('Êtes-vous sûr de vouloir supprimer cette réclamation ?');">
                                        @csrf
                                        @method('DELETE')
